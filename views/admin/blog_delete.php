									...
									<?php foreach( $posts as $row )  { ?>
										<tr>
											...
											<td  style="display: flex;">
												...
												<a href="index.php?mod=post&act=restore&id=<?php echo $row['id'] ?>" class="btn btn-dark">Restore</a>
												<a href="index.php?mod=post&act=delete4ever&id=<?php echo $row['id'] ?>" class="btn btn-danger">Delete</a>
											</td>
										</tr>
